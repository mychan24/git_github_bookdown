...
This should result in a conflict message where it tells you the smae file was modified by you and your collaborator. 
...
* The conflicted portion of the file is indicated by `<<<<<<<` and `=======`
  ...
  + Changes from the remote version is after `=======` and `>>>>>>> <commit identifier>`
...
```
## [master 0f2d252] Merge changes from Github
```
