...
You can check difference between the current file against a specific commit based on its identifer (the unique identifier is different for you, use `git log` to check!)
